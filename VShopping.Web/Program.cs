...
//builder.Services.AddHttpClient("ProductAPI", config =>
//{
  //  config.BaseAddress = new Uri("https://localhost:7040/api/products/");
...
//Identity para se comunicar com a Web
